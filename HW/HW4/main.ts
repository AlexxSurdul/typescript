...
function squareCalculator(a: number, b: number): number {
    return a * b;
}
...
function circleCalculator(r: number): number {
    return Math.PI * r * r;
}
...
function cylinderCalculator(h: number, r: number): number {
...
function arrayPrinter(...x: any): void {
    // console.log(x);
...
function pCreator(p: string): void {
...
function ulCreator(l: string): void {
    document.write(`
                        <ul>
                            <li>${l}</li>
                            <li>${l}</li>
...
function liCreator(l: string, n: number): void {
...
function arrayPrimitive(arr: any[]): void {
...
function comparatorNumber(arr: number[]): number {
    let min = arr[0];
...
function summarizer(arr: number[]): number {
    let sum = 0;
...
function swaper(arr: number[], index1: number, index2: number): void {
...
function exchanger(sumUAH: number, currencyValues: IcurrencyValues[], exchangeCurrency: string): void {
